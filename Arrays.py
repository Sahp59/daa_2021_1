...
--> basado en los tipos de datos basicos
--> tienen una estructura bien establecida
--> tienen un numero mde operaciones
"""
#ADT ARREGLO
"""
Un ADT que almacena valores del mismo tipo pero diferenciados por un indice
0  1  2  3  4  5
5 12 15 26 30 60   --> numeros
class array
operaciones : array (n)
